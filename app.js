        ...
        window.printSingleDay = printSingleDay;
            ...
            const enhancedContent = `
                <div style="page-break-after: always;">
                    <h2 style="border-bottom: 2px solid #6366f1; padding-bottom: 8px; margin: 30px 0 16px 0;">🚨 Emergency Contacts</h2>
            `;
                ...
                tripData.emergencyContacts.forEach(contact => {
                    printWindow.document.write(`
                        <div style="margin-bottom: 16px; padding: 12px; background: #f8f9fa; border-radius: 8px;">
                            ...
                            <span style="color: #64748b;">📞 ${contact.phone || 'N/A'}</span><br>
                            ${contact.relationship ? '<span style="color: #64748b;">' + contact.relationship + '</span>' : ''}
                        </div>
                    `);
                });
            ...
            // Add collaborative notes to itinerary days
            if (tripData.dayPlans && tripData.dayPlans.some(d => d.collaborativeNotes)) {
                printWindow.document.write(`
                    <div style="page-break-before: always;">
                        <h2 style="border-bottom: 2px solid #6366f1; padding-bottom: 8px; margin-bottom: 16px;">💬 Shared Notes</h2>
                `);
                
                tripData.dayPlans.forEach((day, idx) => {
                    if (day.collaborativeNotes) {
                        printWindow.document.write(`
                            <div style="margin-bottom: 20px;">
                                <h3 style="color: #6366f1;">Day ${idx + 1}${day.city ? ' - ' + day.city : ''}</h3>
                                <p style="background: #f8f9fa; padding: 12px; border-radius: 8px; white-space: pre-wrap;">${day.collaborativeNotes}</p>
                            </div>
                        `);
                    }
                });
